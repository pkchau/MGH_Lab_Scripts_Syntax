...
trial {
	...
	terminator_button = 3;
		picture {
		text { 
			caption = "Great job! You have completed the 2nd round of the 2-back task.\n\nPlease let the experimenter know."; 
			font_size = 14; 
		};
		x = 0; y = 0;
		}; 
...
#Present Real 2-back Run 2 Trials
loop
   int i = 1;
   int last = 0;
   int two_back = 0;
