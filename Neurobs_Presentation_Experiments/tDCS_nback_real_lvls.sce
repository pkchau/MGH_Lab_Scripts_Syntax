...
begin
	...
	begin
		...
		if letters_set[index].description()=="H" then
			n_back_event.set_event_code("91");
		elseif letters_set[index].description()=="D" then
			n_back_event.set_event_code("92");
		elseif letters_set[index].description()=="C" then
			n_back_event.set_event_code("93");
		elseif letters_set[index].description()=="G" then
			n_back_event.set_event_code("94");
		elseif letters_set[index].description()=="M" then
			n_back_event.set_event_code("95");
		elseif letters_set[index].description()=="W" then
			n_back_event.set_event_code("96");
		elseif letters_set[index].description()=="T" then
			n_back_event.set_event_code("97");
		elseif letters_set[index].description()=="N" then
			n_back_event.set_event_code("98");
		elseif letters_set[index].description()=="R" then
			n_back_event.set_event_code("99");
		elseif letters_set[index].description()=="V" then
			n_back_event.set_event_code("910");
		elseif letters_set[index].description()=="P" then
			n_back_event.set_event_code("911");
		elseif letters_set[index].description()=="K" then
			n_back_event.set_event_code("912");
		elseif letters_set[index].description()=="J" then
			n_back_event.set_event_code("913");
		elseif letters_set[index].description()=="L" then
			n_back_event.set_event_code("914");
		elseif letters_set[index].description()=="Q" then
			n_back_event.set_event_code("915");
		elseif letters_set[index].description()=="Z" then
			n_back_event.set_event_code("916");
		elseif letters_set[index].description()=="S" then
			n_back_event.set_event_code("917");
		elseif letters_set[index].description()=="B" then
			n_back_event.set_event_code("918");
		end;
...
#		last.set_event_code(logfile.subject() + "," + string(lvls[x]) + "," + letters_set[index].description() + "," + target_string );
		i = i + 1;
	end;
